...
export default function EditAvatarPopup(props) {
    ...
    return(
      ...
      <label className="popup__label new-avatar__form-label">
        <input ref={ref} id="avatar-input" className="popup__input new-avatar__form-input-link" type="url"
        ...
        <button className="new-avatar__form-submit popup__button" type="submit">Сохранить</button>
      </PopupWithForm>
    )
}