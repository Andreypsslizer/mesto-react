...
export default function Card(props) {
    ...
    return(
        <li className="element">
          {isOwn && <button className="element__trash" onClick={cardDelete}></button>}
          ...
          <div className="element__inf">
            ...
            <div className="element__like">
              <button type="button" className={isLiked ? `element__like-group ${cardLikeButtonClassName}` : `element__like-group`} onClick={handlelike}/>
